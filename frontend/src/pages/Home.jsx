...
export default function Home() {
  return (
    <div className="mt-40">
      ...
      <section className="py-20 bg-blue-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-16">How it Work&apos;s</h2>
              ...
              <Card key={index} className={"p-6"}>
                <CardContent className={"pt-4"}>
                  <div className="flex items-center mb-4">
                    <img src={testimonial.image} alt={testimonial.name} width={40} height={40} className={"rounded-full"} />
                    <div className="ml-4">
      ...
      <section className="py-20 bg-blue-600">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-blue-100 mb-8 max-w-2xl mx-auto">
            Join thousands of users who are already managing their finances smarter with Cents
          </p>
          <Link to={"/dashboard"}>
